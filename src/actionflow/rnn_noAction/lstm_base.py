...
from actionflow.rnn_noAction.rnn_base import RNNBase
from ..rnn_noAction.consts import Const
...
class LSTMBase(RNNBase):
    ...
    def rnn_cells(self, n_cells, rnn_in):
        ...
        state_in = (c_in, h_in)
        step_size = tf.ones([tf.shape(self.prev_rewards)[0]], dtype=tf.int32) * tf.shape(self.prev_rewards)[1]
